...
export const dict = {
  zh: {
    ...
    symbolLookupProgress: "正在透過多管道查詢標的行情...",
    symbolLookupTrying: "正在查詢行情中（嘗試主要與備援管道）...",
    symbolNotFoundTitle: "查無此標的行情數據",
    symbolNotFoundTips: "請確認代號是否正確。範例：美股如 AAPL、VOO、SMH；台股如 2330、0050.TW、00679B.TWO。",
    refreshLatestData: "更新最新數據",
    refreshing: "更新最新數據中...",
    refreshSuccess: "已成功更新至最新數據",
    channelUsedLabel: "資料管道：",
    langToggle: "EN",
    editSymbols: "編輯標的",
    doneEditing: "完成編輯",
    ...
    chartInteractionTip: "💡 提示：懸停下方圖例或走勢線可聚焦特定標的；滑鼠靠近歷史時間點會自動感應重大歷史事件。",
  ...
  en: {
    ...
    symbolLookupProgress: "Looking up symbol across channels...",
    symbolLookupTrying: "Fetching quote across primary & backup channels...",
    symbolNotFoundTitle: "Symbol Market Data Not Found",
    symbolNotFoundTips: "Please verify the ticker symbol. Examples: US stocks/ETFs like AAPL, VOO, SMH; Taiwan tickers like 2330, 0050.TW, 00679B.TWO.",
    refreshLatestData: "Refresh Latest Data",
    refreshing: "Refreshing latest data...",
    refreshSuccess: "Latest data updated successfully",
    channelUsedLabel: "Data Source:",
    langToggle: "中",
    ...
    chartInteractionTip: "💡 Tip: Hover over the legend or lines to focus a symbol. Hover near historical dates to view major crises.",
